...
# Source notebook: 12_wind_gyre_reduced_gravity.ipynb
...
anim.save(str(ANIMATION_DIR / "eta_12.gif"), fps=10)
...
# GIF (no external dependencies)
anim.save(str(ANIMATION_DIR / "eta_12b_nonlinear.gif"), fps=10)
